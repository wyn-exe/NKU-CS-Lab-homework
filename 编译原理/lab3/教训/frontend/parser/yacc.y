...
%token PLUSPLUS MINUSMINUS                /* 递增递减运算符 */
%token ASSIGN PLUSEQ MINUSEQ MULEQ DIVEQ MODEQ BITOREQ BITANDEQ BITXOREQ LSHIFTEQ RSHIFTEQ        /* 复合赋值运算符 */
...
%nterm <FE::AST::ExprNode*> CONDITIONAL_EXPR
...
ASSIGN_EXPR:
    ...
    | LEFT_VAL_EXPR PLUSEQ ASSIGN_EXPR {
        $$ = new BinaryExpr(Operator::ADD_ASSIGN, $1, $3, @2.begin.line, @2.begin.column);
    }
    | LEFT_VAL_EXPR MINUSEQ ASSIGN_EXPR {
        $$ = new BinaryExpr(Operator::SUB_ASSIGN, $1, $3, @2.begin.line, @2.begin.column);
    }
    | LEFT_VAL_EXPR MULEQ ASSIGN_EXPR {
        $$ = new BinaryExpr(Operator::MUL_ASSIGN, $1, $3, @2.begin.line, @2.begin.column);
    }
    | LEFT_VAL_EXPR DIVEQ ASSIGN_EXPR {
        $$ = new BinaryExpr(Operator::DIV_ASSIGN, $1, $3, @2.begin.line, @2.begin.column);
    }
    | LEFT_VAL_EXPR MODEQ ASSIGN_EXPR {
        $$ = new BinaryExpr(Operator::MOD_ASSIGN, $1, $3, @2.begin.line, @2.begin.column);
    }
    | LEFT_VAL_EXPR BITOREQ ASSIGN_EXPR {
        $$ = new BinaryExpr(Operator::BITOR_ASSIGN, $1, $3, @2.begin.line, @2.begin.column);
    }
    | LEFT_VAL_EXPR BITANDEQ ASSIGN_EXPR {
        $$ = new BinaryExpr(Operator::BITAND_ASSIGN, $1, $3, @2.begin.line, @2.begin.column);
    }
    | LEFT_VAL_EXPR BITXOREQ ASSIGN_EXPR {
        $$ = new BinaryExpr(Operator::BITXOR_ASSIGN, $1, $3, @2.begin.line, @2.begin.column);
    }
    | LEFT_VAL_EXPR LSHIFTEQ ASSIGN_EXPR {
        $$ = new BinaryExpr(Operator::LSHIFT_ASSIGN, $1, $3, @2.begin.line, @2.begin.column);
    }
    | LEFT_VAL_EXPR RSHIFTEQ ASSIGN_EXPR {
        $$ = new BinaryExpr(Operator::RSHIFT_ASSIGN, $1, $3, @2.begin.line, @2.begin.column);
    }
    ;
...
CONDITIONAL_EXPR:
    ...
    | LOGICAL_OR_EXPR QUESTION EXPR COLON CONDITIONAL_EXPR {
        $$ = new ConditionalExpr($1, $3, $5, @2.begin.line, @2.begin.column);
    }
    ;
...
SHIFT_EXPR:
    SHIFT_EXPR LSHIFT ADDSUB_EXPR {
        $$ = new BinaryExpr(Operator::LSHIFT, $1, $3, @2.begin.line, @2.begin.column);
    }
    | SHIFT_EXPR RSHIFT ADDSUB_EXPR {
        $$ = new BinaryExpr(Operator::RSHIFT, $1, $3, @2.begin.line, @2.begin.column);
    }
    | ADDSUB_EXPR {
        $$ = $1;
    }
...
BIT_XOR_EXPR:  // 位异或表达式
    BIT_XOR_EXPR BITXOR BIT_AND_EXPR {
        $$ = new BinaryExpr(Operator::BITXOR, $1, $3, @2.begin.line, @2.begin.column);
    }
    | BIT_AND_EXPR {
        $$ = $1;
    }
...
UNARY_EXPR:
    ...
    | PLUSPLUS LEFT_VAL_EXPR {
        $$ = new UnaryExpr(Operator::PRE_INC, $2, @1.begin.line, @1.begin.column);
    }
    | MINUSMINUS LEFT_VAL_EXPR {
        $$ = new UnaryExpr(Operator::PRE_DEC, $2, @1.begin.line, @1.begin.column);
    }
    ;
...
POSTFIX_EXPR:
    ...
    | POSTFIX_EXPR PLUSPLUS {
        $$ = new UnaryExpr(Operator::POST_INC, $1, @2.begin.line, @2.begin.column);
    }
    | POSTFIX_EXPR MINUSMINUS {
        $$ = new UnaryExpr(Operator::POST_DEC, $1, @2.begin.line, @2.begin.column);
    }
    ;
