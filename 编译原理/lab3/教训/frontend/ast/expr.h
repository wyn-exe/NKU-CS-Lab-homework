...
namespace FE::AST
{
    ...
    class ConditionalExpr : public ExprNode
    {
      public:
        ExprNode* cond;
        ExprNode* trueExpr;
      ...
      public:
        ConditionalExpr(
            ExprNode* cond, ExprNode* trueExpr, ExprNode* falseExpr, int line_num = -1, int col_num = -1)
            : ExprNode(line_num, col_num), cond(cond), trueExpr(trueExpr), falseExpr(falseExpr)
        {}
        virtual ~ConditionalExpr() override;
