...
# train_fuc(mode='RNN',batch_size=batch_size,epochs=8)//0.8891
# train_fuc(mode='MLP',epochs=epochs)//0.8945
# train_fuc(mode='CNN',epochs=epochs)//0.8961
# train_fuc(mode='LSTM',epochs=epochs)//0.8986
# train_fuc(mode='GRU',epochs=epochs)//0.8944
# train_fuc(mode='CNN+LSTM',epochs=epochs)//0.8911
# train_fuc(mode='BiLSTM',epochs=epochs)//0.8893
# train_fuc(mode='TextCNN',epochs=8)//0.8905
# train_fuc(mode='Transformer',epochs=8)//0.8928
# train_fuc(mode='PositionalEmbedding+Transformer',batch_size=batch_size,epochs=3)//0.8946
